...
function toggleCamView() {
  const show = document.getElementById('camViewCheck').checked;
...
function stopCam() {
  ...
  document.getElementById('camViewCheck').checked = false;
...
function renderLoop() {
  ...
  const camVisible = document.getElementById('camViewCheck').checked;
  ...
  const availableW = (camVisible && !isMobile)
  ...
  // Mirror ascii output's exact dimensions (including padding + border) onto the video
